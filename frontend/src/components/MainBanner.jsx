...
const MainBanner = () => {
  return (
    <div className='relative'>
        <img src={assets.main_banner_bg} alt="banner"  className='w-full hidden md:block'/> {/* it will hiden on mobile phone and  in medium screen it will be visible */}
        <img src={assets.main_banner_bg_sm} alt="banner"  className='w-full md:hidden'/> {/* it will visible in mobile screen remainig screns it will be hiden */}  
