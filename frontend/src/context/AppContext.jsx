...
axios.defaults.withCredentials = true // it send the cookies also in api
...
export const AppContextProvider = ({ children }) => {
    ...
    //bd- fetch user auth status , user data and cart items
    ...
    {/* dummy products data  fetching in assets  in show the best sellers */}
    {/* fetch all products */}
    ...
    // get cart total Amount  (calculate amount)
